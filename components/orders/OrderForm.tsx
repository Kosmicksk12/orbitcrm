    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        <div className="space-y-3">
          <p className="text-xs font-semibold uppercase tracking-wide text-ink-muted dark:text-ink-dark-muted">
            Cliente
          </p>
        ...
        <div className="space-y-3 border-t border-line pt-5 dark:border-line-dark">
          <p className="text-xs font-semibold uppercase tracking-wide text-ink-muted dark:text-ink-dark-muted">
            Equipo y falla
          </p>
          <div className="grid grid-cols-2 gap-3">
