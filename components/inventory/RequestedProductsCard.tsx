...
export function RequestedProductsCard() {
  ...
  return (
    <Card className="mt-6 p-5">
      <h2 className="text-sm font-semibold text-ink dark:text-ink-dark">Productos solicitados</h2>
      <p className="mt-1 text-xs text-ink-muted dark:text-ink-dark-muted">
        Productos que preguntan los clientes y no hay en stock, para tenerlos en cuenta al comprar.
      </p>
