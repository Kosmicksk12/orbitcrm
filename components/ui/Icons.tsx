...
export const IconWhatsapp = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)}>
    <path d="M6 18l1.1-3.3A7.5 7.5 0 1112 19.5a7.4 7.4 0 01-3.3-.77z" />
    <path d="M9.2 9.3c.15-.35.3-.36.5-.36h.4c.13 0 .3-.05.47.35.17.4.6 1.4.65 1.5.05.1.09.22.02.36-.07.13-.11.22-.22.34-.11.12-.23.27-.33.36-.11.1-.23.21-.1.42.13.2.57.95 1.23 1.53.85.75 1.55.99 1.76 1.1.22.1.34.09.47-.05.13-.14.55-.63.7-.85.15-.21.3-.18.5-.1.2.07 1.3.6 1.52.72.22.11.36.17.42.26.06.1.06.55-.13 1.09-.2.53-1.13 1.02-1.55 1.08-.4.06-.9.09-1.46-.09a12.6 12.6 0 01-.55-.19 9.6 9.6 0 01-3.55-2.5 10.6 10.6 0 01-1.98-3.03c-.2-.5-.3-.9-.28-1.31.03-.4.24-.87.44-1.13z" />
  </svg>
);
